...
// CreateAccessToken create access tokens on behalf user
func CreateAccessToken(ctx *context.APIContext) {
	// swagger:operation POST /admin/users/{username}/tokens admin adminUserCreateToken
	// ---
...
// DeleteAccessToken delete access tokens on behalf user
func DeleteAccessToken(ctx *context.APIContext) {
	// swagger:operation DELETE /admin/users/{username}/tokens/{token} admin adminUserDeleteAccessToken
	// ---
	...
	if err := auth_model.DeleteAccessTokenByID(tokenID, ctx.ContextUser.ID); err != nil {
